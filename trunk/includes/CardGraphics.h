...
const unsigned int CRD_ATTACK_SYMBOL	=	0;
const unsigned int CRD_DEFENSE_SYMBOL	=	1;
const unsigned int CRD_INNOVATION_SYMBOL	=	2;
const unsigned int CRD_ECONOMY_SYMBOL	=	3;
const unsigned int CRD_POWER_SYMBOL	=	4;
